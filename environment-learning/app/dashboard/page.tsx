...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ["Plastic bags", "Fishing nets", "Plastic bottles", "Food packaging"],
    correct: 1,
    points: 20,
  },
  {
  ...
  },
  {
    ...
    options: ["Tropical rainforests", "Peatlands", "Grasslands", "Temperate forests"],
    correct: 1,
    points: 20,
  },
  {
...
const flashcardsData = [
  {
    id: 1,
    title: "Drought",
    disaster: "Extended periods of abnormally low rainfall leading to water scarcity and crop failure",
    prevention:
  ...
  },
  {
    id: 2,
    title: "Floods",
    disaster: "Overflow of water onto normally dry land causing property damage and displacement",
    prevention:
  ...
  },
  {
    id: 3,
    title: "Hurricanes",
    disaster: "Powerful tropical storms with high winds and heavy rainfall causing widespread destruction",
    prevention:
  ...
  },
  {
    id: 4,
    title: "Wildfires",
    disaster: "Uncontrolled fires spreading rapidly through vegetation and threatening communities",
    prevention:
  ...
  },
  {
    id: 5,
    title: "Earthquakes",
    disaster: "Sudden ground shaking caused by tectonic plate movement leading to structural collapse",
    prevention:
  ...
  },
  {
    id: 6,
    title: "Tsunamis",
    disaster: "Large ocean waves caused by underwater earthquakes threatening coastal communities",
    prevention:
  ...
  },
  {
    id: 7,
    title: "Landslides",
    disaster: "Movement of rock, earth, or debris down slopes threatening lives and property",
    prevention:
  ...
  },
  {
    id: 8,
    title: "Tornadoes",
    disaster: "Violently rotating columns of air causing severe damage along their path",
    prevention:
  ...
  },
  {
    ...
    disaster: "Explosive release of magma, ash, and gases from volcanoes affecting large areas",
    prevention:
  ...
  },
  {
    id: 10,
    title: "Heatwaves",
    disaster: "Prolonged periods of excessively hot weather causing health risks and infrastructure stress",
    prevention:
  ...
  },
  {
    id: 11,
    title: "Blizzards",
    disaster: "Severe snowstorms with high winds and heavy snowfall disrupting transportation and power",
    prevention:
  ...
  },
  {
    id: 12,
    title: "Ice Storms",
    disaster: "Freezing rain creating ice accumulation that damages power lines and trees",
    prevention:
  ...
  },
  {
    id: 13,
    title: "Dust Storms",
    disaster: "Large clouds of dust and sand reducing visibility and causing respiratory problems",
    prevention:
  ...
  },
  {
    id: 14,
    title: "Avalanches",
    disaster: "Rapid flow of snow down mountainsides threatening skiers and mountain communities",
    prevention:
  ...
  },
  {
    ...
    disaster: "Gradual wearing away of coastlines threatening coastal communities and infrastructure",
    prevention:
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav className="sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          >
            ...
            <span className="text-2xl font-bold text-foreground">TerraLearn</span>
          </button>

          <div className="hidden md:flex items-center gap-2">
            {[
              { name: "Quiz", icon: Brain, action: handleQuizClick },
              { name: "Flashcards", icon: BookOpen, action: handleFlashcardsClick },
              { name: "Leaderboard", icon: Trophy, action: handleLeaderboardClick },
              {
                name: "Games",
                icon: Gamepad2,
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 bg-gradient-to-r from-green-100 to-emerald-100 px-4 py-2 rounded-full border border-green-200 hover:shadow-lg transition-all duration-300 hover:scale-105">
              ...
              <span className="font-bold text-green-800 text-lg">{userPoints.toLocaleString()}</span>
                ...
                <button className="relative group">
                  <div className="flex items-center gap-3 p-2 rounded-full hover:bg-green-50 transition-all duration-300 hover:shadow-lg">
                    <Avatar className="h-10 w-10 border-2 border-green-200 group-hover:border-green-400 transition-colors duration-300">
                      ...
                      <AvatarFallback className="bg-green-100 text-green-700 font-semibold">AS</AvatarFallback>
                    </Avatar>
                    <div className="hidden lg:block text-left">
                      <div className="text-sm font-semibold text-foreground">Alex Student</div>
                      <div className="text-xs text-muted-foreground">Level 12 Eco Warrior</div>
                    </div>
                  </div>
                  {/* Online indicator */}
              ...
              <DropdownMenuContent align="end" className="w-64 p-2">
                <DropdownMenuLabel className="flex items-center gap-3 p-3">
                  <Avatar className="h-12 w-12">
                    <AvatarImage src="/student-avatar.png" alt="Profile" />
                    <AvatarFallback className="bg-green-100 text-green-700 font-semibold text-lg">AS</AvatarFallback>
                  </Avatar>
                  <div>
                    <div className="font-semibold">Alex Student</div>
                    <div className="text-sm text-muted-foreground">alex.student@school.edu</div>
      ...
      {showFlashcards && (
        <section id="flashcards" className="py-8 px-4 bg-gradient-to-r from-emerald-50 to-green-50">
          <div className="container mx-auto max-w-4xl">
      ...
      {showLeaderboard && (
        <section id="leaderboard" className="py-8 px-4 bg-gradient-to-r from-yellow-50 to-orange-50">
          <div className="container mx-auto max-w-4xl">
      ...
      <section className="py-20 px-4 text-center bg-gradient-to-br from-background via-green-50/30 to-background">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-green-600 text-white hover:bg-green-700" onClick={() => handleQuizClick()}>
          ...
          {[
            ...
            },
            {
              ...
              action: () => {
                ...
                setTimeout(() => document.getElementById("flashcards")?.scrollIntoView({ behavior: "smooth" }), 100)
              },
            },
            {
              name: "Games",
