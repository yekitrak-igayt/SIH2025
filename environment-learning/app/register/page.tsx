...
export default function RegisterPage() {
  ...
  const handleCreateAccount = async () => {
    ...
    try {
      ...
      localStorage.setItem("terralearn_user", JSON.stringify(userData))
      ...
      <div className="flex items-center justify-center min-h-screen p-4 relative z-10">
        <Card className="w-full max-w-md bg-white/95 backdrop-blur-sm border-2 border-green-300 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 animate-card-entrance">
          <CardHeader className="text-center space-y-4">
            ...
            <CardTitle className="text-2xl font-bold text-green-800 animate-text-glow">Join TerraLearn</CardTitle>
            <CardDescription className="text-green-600">
              Create your account and start your eco-learning adventure
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-start space-x-2 text-sm">
              <input type="checkbox" className="rounded border-green-300 text-green-600 focus:ring-green-400 mt-0.5" />
            ...
            <Button
              ...
              disabled={isLoading}
              className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-3 transition-all duration-300 hover:scale-105 hover:shadow-lg animate-button-pulse disabled:opacity-50 disabled:cursor-not-allowed"
              size="lg"
            >
              {isLoading ? (
                <>
            ...
            <div className="text-center text-sm text-green-600">
              ...
              <Link href="/" className="text-green-700 hover:text-green-800 transition-colors font-medium underline">
                Sign in here!
              </Link>
            </div>
          </CardContent>
